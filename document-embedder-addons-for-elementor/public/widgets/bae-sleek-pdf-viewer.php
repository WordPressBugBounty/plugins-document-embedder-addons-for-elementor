...
class bae_sleek_pdf_viewer extends Widget_Base {
	...
	public function render_common_style_settings() {
		$this->bae_box_common_styles_render( $id = 'pdf_viewer', $label = 'PDF Viewer', $condition = [], $selector = '#sleek-pdf-viewer' );
		$this->bae_text_common_styles_render( $id = 'file_name', $label = 'File Name', $condition = [ 'file_name' => 'yes' ], $selector = '.sleek_pdf_viewer_style h3', $default = 'PDF Test File' );
		$this->bae_button_common_styles_render( $id = 'download_btn', $label = 'Download Button', $condition = [ 'download_button' => 'yes' ], $selector = '.sleek_pdf_viewer_style .bbutton-bottom', $default = 'Download PDF' );
	}
